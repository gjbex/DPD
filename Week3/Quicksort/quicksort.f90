program quicksort
      ...
      real, dimension(-n/2:n/2) :: more_values
      integer :: i
      character(len=10) :: fmt_str

      ! create format string
      write (fmt_str, '(A, I0, A)') '(', n, 'F9.5)'

      ! initialize data, print, sort, print
      do i = 1, n
          more_values(i) = real(i - n/2)
      end do
      print fmt_str, more_values
      call qsort(more_values)
      print fmt_str, more_values

      ! initialize random data, print, sort, print
